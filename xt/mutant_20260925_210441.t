...
# --- SURVIVOR: NUM_BOUNDARY_953_25_> (HIGH) line 953 in parse_prereqs() ---
...
#   Numeric boundary flip >= to <=
TODO: {
    local $TODO = 'Complete: NUM_BOUNDARY_953_25_> line 953 in parse_prereqs()';
    # NOTE: App::makefilepl2cpanfile has no constructor — call class methods directly.
    # e.g. my $result = App::makefilepl2cpanfile->method(...);
    # TODO: exercise line 953 in parse_prereqs() to detect the mutant
